...
| **[The skill fleet](skills.md)** | What does one skill look like inside, and how do the twenty-three relate? | Contributors |
...
**4 · Law loads.** `harness-policy.md`, `loop-policy.md`, `execution-modes.md`. Read-only. These govern *shape* and *routing* and are the reason twenty-three skills share one orchestration discipline rather than twenty-three dialects.
