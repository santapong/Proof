...
6. **Re-check the neighbours.** Each added skill is more selection pressure on the other twenty-four, not the same. Every overlap it touches needs its pointer on both sides.
