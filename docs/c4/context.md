...
No skills, no policies, no templates, no `ROUTES` block, no phases. Twenty-two skills drawn as twenty-three peer boxes would be the classic Level-1 mistake: from the outside, this is one plugin with one entry point per task. Open the box at [Level 2 — Container](container.md).
