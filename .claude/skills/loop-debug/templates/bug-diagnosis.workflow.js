...
// input.mode       — 'optimize' (default) or 'full' (execution-modes.md §M2). All-out mode runs
...
// Mode picks how MANY of these run (WIDTH('verify') — 1 in balanced, 3 in full); it never invents
...
// Width is mode-resolved (§M5): one investigator per hypothesis in balanced, three diverse
