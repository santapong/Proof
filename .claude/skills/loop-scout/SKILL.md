...
Use the **`loop-research`** skill to run the actual search and verify claims about candidates (adoption, maintenance, security) against real sources rather than memory.
