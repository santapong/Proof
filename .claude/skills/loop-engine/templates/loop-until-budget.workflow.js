...
//
// --budget × --mode full: in full mode the ceiling is PRE-APPROVED at the pre-flight
...
// That is deliberately stricter than H6. In optimize mode the runtime guard below is
...
return { items: results, rounds: round, mode: MODE }
