...
// guideline, which §M6 DECIDES wins over all-out mode's appetite: each surviving candidate costs
// 1 apply agent + WIDTH('verify') verify agents, on top of the finders already spent. All-out mode
